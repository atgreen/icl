...
(defvar *inline-hints-enabled* t
  "When T, show inline completion hints (ghost text) when there is exactly one match.")
...
;;; ─────────────────────────────────────────────────────────────────────────────
;;; Color Configuration (tuition complete-color objects)
;;; ─────────────────────────────────────────────────────────────────────────────

;;; Syntax highlighting colors — set by apply-terminal-theme
(defvar *hl-keyword-color* nil
  "Complete-color for keywords (like :foo).")
(defvar *hl-string-color* nil
  "Complete-color for string literals.")
(defvar *hl-comment-color* nil
  "Complete-color for comments.")
(defvar *hl-number-color* nil
  "Complete-color for numeric literals.")
(defvar *hl-symbol-color* nil
  "Complete-color for regular symbols.")
(defvar *hl-package-color* nil
  "Complete-color for package prefixes.")
(defvar *hl-special-color* nil
  "Complete-color for special forms and macros.")

;;; Paren colors — set by apply-terminal-theme
(defvar *hl-paren-color* nil
  "Complete-color for parentheses.")
(defvar *hl-paren-match-bg-color* nil
  "Complete-color for matching paren background.")
(defvar *hl-paren-mismatch-bg-color* nil
  "Complete-color for mismatched paren background.")

;;; Text style flags — set by apply-terminal-theme
(defvar *comment-italic* t
  "Whether comments should be rendered in italic.")
(defvar *special-bold* t
  "Whether special forms should be rendered in bold.")
(defvar *keyword-bold* nil
  "Whether keywords should be rendered in bold.")

;;; UI colors — set by apply-terminal-theme
(defvar *color-prompt* nil
  "Complete-color for main prompt.")
(defvar *color-package* nil
  "Complete-color for package name in prompt.")
(defvar *color-error* nil
  "Complete-color for error messages.")
(defvar *color-warning* nil
  "Complete-color for warning messages.")
(defvar *color-info* nil
  "Complete-color for info messages.")
(defvar *color-dim* nil
  "Complete-color for dimmed/secondary text.")
...
;;; Color sequences (generated by refresh-ansi-codes from complete-color objects)
(defvar *ansi-prompt* nil
  "ANSI sequence for prompt color.")
(defvar *ansi-package* nil
  "ANSI sequence for package color.")
(defvar *ansi-error* nil
  "ANSI sequence for error color.")
(defvar *ansi-warning* nil
  "ANSI sequence for warning color.")
(defvar *ansi-info* nil
  "ANSI sequence for info color.")
(defvar *ansi-fg-gray* nil

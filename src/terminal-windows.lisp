...
(defun read-key ()
  ...
  (let ((c (read-char-raw)))
    ...
    (cond
      ...
      ((char= c (code-char 24)) :cut)           ; Ctrl-X
      ((char= c #\Tab) :tab)
      ;; Regular character
      (t c))))
